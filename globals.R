...
PITCHER_TARGETS <- list(900, 90, 1000, 195, format(3.80, nsmall=2), format(1.25, nsmall=2), 140, 130)
...
team <- c("Phoenix"=1, "Bisons"=2, "Libs"=3, 
          "Portsiders"=4, "TwelfthMan"=5, "SSF"=6, 
...
playerPositions <- c("C1", "C2", "1B", "CI", "3B",
                  ...
                  "OF1", "OF2", "OF3", "OF4", "OF5",
                  "DH",
                  "RES1", "RES2", "RES3", "RES4", "RES5", "RES6", "ML1", "ML2",
                  "DL1", "DL2", "DL3", "DL4", "DL5", 
...
#allPositions <- c(playerPositions, pitcherPositions)
